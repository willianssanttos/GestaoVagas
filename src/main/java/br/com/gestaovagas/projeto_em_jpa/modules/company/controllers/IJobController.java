...
public interface IJobController {
    ...
    ResponseEntity<Object> create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request);
    ...
    ResponseEntity<Object> listByCompany(HttpServletRequest request);
}
